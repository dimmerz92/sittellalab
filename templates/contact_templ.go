	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if !props.Success {
				...
				_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(" <form action=\"/contact\" method=\"post\" onsubmit=\"document.getElementById(&#39;loading&#39;).style.visibility = &#39;visible&#39;;\"><div class=\"two-col\"><label class=\"input\">First Name <input type=\"text\" name=\"firstname\" required></label> <label class=\"input\">Last Name <input type=\"text\" name=\"lastname\" required></label></div><div class=\"two-col\"><label class=\"input\">Email <input type=\"email\" name=\"email\" required></label> <label class=\"input\">Enquiry Type <select name=\"enquiry-type\"><option value=\"web\">Web Development</option> <option value=\"data\">Data Analytics</option> <option value=\"consult\">Consulting</option> <option value=\"other\">Other</option></select></label></div><label class=\"input\">Message  <textarea name=\"message\" required></textarea></label> <button type=\"submit\">Send Enquiry</button></form><div id=\"loading\"><div><h3 style=\"font-size: x-large; color: var(--white);\">Your enquiry is being sent</h3><div class=\"spinner\"><div></div><div></div><div></div><div></div></div></div></div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			} else {
